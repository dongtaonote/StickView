package com.example.stickview.scrollablelayout.scrollhelper;
...
public class ScrollableLayout extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ScrollAbleLayout);
        topMargin = typedArray.getDimensionPixelOffset(R.styleable.ScrollAbleLayout_stickViewTopMargin, 0);
        typedArray.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        maxY = mHeadView.getMeasuredHeight() - topMargin;
